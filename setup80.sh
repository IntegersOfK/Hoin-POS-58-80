...
echo "Copying rastertopos filter to $DESTDIR/$FILTERDIR"
mkdir -p $DESTDIR/$FILTERDIR
chmod +x ./bin/rastertopos
cp ./bin/rastertopos $DESTDIR/$FILTERDIR
echo ""
...
echo "Add POS-80-Series printer"
lpadmin -p POS-80-Series -E -v socket://192.168.1.100:9100 -P /usr/share/cups/model/pos/pos80.ppd
echo ""
